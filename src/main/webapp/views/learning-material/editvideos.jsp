...
<form:form action="learning-material/videos/edit.do" modelAttribute="videos">
	...
	<form:label path="youtubeIdentifier">
		<spring:message code="videos.youtubeIdentifier" />:
	</form:label>
	<form:input path="youtubeIdentifier" />
	<form:errors cssClass="error" path="youtubeIdentifier" />
	<br />
