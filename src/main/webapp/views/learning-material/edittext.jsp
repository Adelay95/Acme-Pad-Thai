...
<form:form action="learning-material/text/edit.do" modelAttribute="text"> 
	<form:hidden path="id" />
	...
	<form:label path="htmlText">
		<spring:message code="text.htmlText" />:
	</form:label>
	<form:textarea path="htmlText" />
	<form:errors cssClass="error" path="htmlText" />
	<br />
